...
var _siteData_default = deserializeFunctions(JSON.parse("{\"lang\":\"ru-RU\",\"dir\":\"ltr\",\"title\":\"Create NSMP Embedded App\",\"description\":\"Генератор встроенных приложений NSMP на Vue, TypeScript и Vite\",\"base\":\"/create-nsmp-embedded-app/\",\"head\":[],\"router\":{\"prefetchLinks\":true},\"appearance\":true,\"themeConfig\":{\"logo\":\"/logo.svg\",\"siteTitle\":\"NSMP Embedded App\",\"nav\":[{\"text\":\"Работа с шаблоном\",\"link\":\"/template/\"},{\"text\":\"Разработка генератора\",\"link\":\"/generator/\"}],\"sidebar\":{\"/generator/\":[{\"text\":\"О генераторе\",\"items\":[{\"text\":\"Как работает генератор\",\"link\":\"/generator/\"}]},{\"text\":\"Разработка генератора\",\"items\":[{\"text\":\"Дополнительные зависимости\",\"link\":\"/generator/optional-dependencies\"},{\"text\":\"Работа с репозиторием\",\"link\":\"/generator/development\"},{\"text\":\"Команды разработки\",\"link\":\"/generator/commands\"}]}],\"/template/\":[{\"text\":\"Работа с шаблоном\",\"items\":[{\"text\":\"Возможности шаблона\",\"link\":\"/template/\"},{\"text\":\"Быстрый старт\",\"link\":\"/template/getting-started\"},{\"text\":\"Переменные окружения\",\"link\":\"/template/environment\"},{\"text\":\"Локальный запуск\",\"link\":\"/template/development\"},{\"text\":\"Сборка приложения\",\"link\":\"/template/build\"},{\"text\":\"Команды\",\"link\":\"/template/commands\"}]},{\"text\":\"Публикация\",\"items\":[{\"text\":\"Загрузка в NSMP\",\"link\":\"/template/deployment\"},{\"text\":\"GitHub Actions\",\"link\":\"/template/github-actions\"},{\"text\":\"GitLab CI\",\"link\":\"/template/gitlab-ci\"}]},{\"text\":\"Утилиты\",\"items\":[{\"text\":\"Утилиты шаблона\",\"link\":\"/template/utils/\"},{\"text\":\"Version\",\"link\":\"/template/utils/version\"},{\"text\":\"Theme\",\"link\":\"/template/utils/theme\"}]},{\"text\":\"Помощь\",\"items\":[{\"text\":\"Устранение проблем\",\"link\":\"/template/troubleshooting\"}]}]},\"search\":{\"provider\":\"local\",\"options\":{\"translations\":{\"button\":{\"buttonText\":\"Поиск\",\"buttonAriaLabel\":\"Поиск по документации\"},\"modal\":{\"noResultsText\":\"Ничего не найдено\",\"resetButtonTitle\":\"Сбросить поиск\",\"footer\":{\"selectText\":\"выбрать\",\"navigateText\":\"перейти\",\"closeText\":\"закрыть\"}}}}},\"socialLinks\":[{\"icon\":\"github\",\"link\":\"https://github.com/ErilovNikita/create-nsmp-embedded-app\"},{\"icon\":\"npm\",\"link\":\"https://www.npmjs.com/package/create-nsmp-embedded-app\"}],\"editLink\":{\"pattern\":\"https://github.com/ErilovNikita/create-nsmp-embedded-app/edit/main/docs/:path\",\"text\":\"Предложить изменение\"},\"lastUpdated\":{\"text\":\"Обновлено\"},\"docFooter\":{\"prev\":\"Предыдущая страница\",\"next\":\"Следующая страница\"},\"outline\":{\"label\":\"На этой странице\",\"level\":[2,3]},\"returnToTopLabel\":\"Наверх\",\"sidebarMenuLabel\":\"Меню\",\"darkModeSwitchLabel\":\"Тема оформления\",\"lightModeSwitchTitle\":\"Включить светлую тему\",\"darkModeSwitchTitle\":\"Включить тёмную тему\"},\"locales\":{},\"cleanUrls\":true,\"additionalConfig\":{}}"));
//#endregion
...
function pathToFile(path) {
	...
	if (inBrowser) {
		const base = "/create-nsmp-embedded-app/";
		pagePath = sanitizeFileName(pagePath.slice(26).replace(/\//g, "_") || "index") + ".md";
...
var VPSwitch_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main$4, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-1d5665e3"]]);
//#endregion
...
var VPNavBarAskAiButton_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main$3, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-4eb17e89"]]);
//#endregion
...
var VPNavBarSearch_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	__ssrInlineRender: true,
	setup(__props) {
		const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.DbktWsYb.js"));
